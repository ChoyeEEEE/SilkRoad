            ...
            <svg class="route-svg" viewBox="0 0 900 320" preserveAspectRatio="xMidYMid meet">
              ...
              <g v-for="(city, i) in routeCityData" :key="city.name"
                ...
                <text :y="city.labelAbove ? (activeCity === i ? -32 : -26) : (activeCity === i ? 38 : 32)"
                      ...
                      font-family="Noto Sans SC, sans-serif" font-weight="bold">
                  {{ city.name }}
                </text>
              ...
              <g class="direction-arrows">
                <text x="200" y="80" font-size="10" fill="rgba(139,0,0,0.7)" font-family="Noto Sans SC, sans-serif">
                  ← 西传
                </text>
                <text x="650" y="80" font-size="10" fill="rgba(47,79,79,0.7)" font-family="Noto Sans SC, sans-serif">
                  东传 →
                </text>
              </g>
            </svg>
